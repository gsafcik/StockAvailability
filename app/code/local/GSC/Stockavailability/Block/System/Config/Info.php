    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
	public function render(Varien_Data_Form_Element_Abstract $element)
	{
		$html = '<div style="background-color:#FAFAFA; border:1px solid #D6D6D6; margin-bottom:10px; padding:10px 5px 5px 30px;">
						...
						<p style="font-size:10px"><span style="font-weight:bold;">Note:</span> This module does <span style="font-weight:bold; text-decoration:underline;">not</span> fix the <a href="http://www.magentocommerce.com/bug-tracking/issue?issue=13610" target="_blank">Magento Credit Memo quanity bug</a> for Magento ver. 1.6.* or less </p>
					</div>';
